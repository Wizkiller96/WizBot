...
namespace WizBot.Tests
{
    ...
    {
        private const string responsesPath = "../../../../WizBot/strings/responses";
        private const string commandsPath = "../../../../WizBot/strings/commands";
        private const string aliasesPath = "../../../../WizBot/strings/aliases.yml";
        ...
        private static string[] GetCommandMethodNames()
            => typeof(Bot).Assembly
                ...
                .Where(type => typeof(WizModule).IsAssignableFrom(type) // if its a top level module
