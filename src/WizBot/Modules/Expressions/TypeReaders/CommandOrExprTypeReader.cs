...
public sealed class CommandOrExprTypeReader : WizTypeReader<CommandOrExprInfo>
{
    private readonly CommandService _cmds;
    private readonly ICommandHandler _commandHandler;
    private readonly WizExpressionsService _exprs;

    public CommandOrExprTypeReader(CommandService cmds, WizExpressionsService exprs, ICommandHandler commandHandler)
    {
        _cmds = cmds;
        _exprs = exprs;
