...
namespace WizBot.Modules.Permissions
{
    public partial class Permissions
    {
        ...
        public class GlobalPermissionCommands : WizBotSubmodule
        {
            ...
            {
                BlockedModules = new ConcurrentHashSet<string>(WizBot.BotConfig.BlockedModules.Select(x => x.Name));
                BlockedCommands = new ConcurrentHashSet<string>(WizBot.BotConfig.BlockedCommands.Select(x => x.Name));
            }
