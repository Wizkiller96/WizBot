        ...
        INService
{
    ...
    public async Task<OneOf.OneOf<WizCommandCallModel, GetCommandErrorResult>> TryGetCommandAsync(
        ulong userId,
        string prompt,
        ...
        string prefix)
    {
        ...
        var comModel = new WizCommandCallModel()
        {
            Name = funcModel.Name,
        ...
        string query)
    {
        ...
        var errorMsg = error switch
        {
            ...
            GetCommandErrorResult.NotAuthorized
                => "In order to use this command you have to have a 5$ or higher subscription at <https://patreon.com/wiznet>",
    ...
    private string GetCommandString(WizCommandCallModel res)
