...
{
    [Group]
    public partial class JokeCommands : WizModule<SearchesService>
    {
        [Cmd]
        ...
        public async Task WowJoke()
        {
            ...
            var joke = _service.WowJokes[new WizRandom().Next(0, _service.WowJokes.Count)];
        ...
        public async Task MagicItem()
        {
            ...
            var item = _service.MagicItems[new WizRandom().Next(0, _service.MagicItems.Count)];
