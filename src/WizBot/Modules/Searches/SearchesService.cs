...
public class SearchesService : INService
{
    ...
    public async Task<WeatherData> GetWeatherDataAsync(string query)
    {
        ...
        return await _c.GetOrAddAsync(new($"wiz_weather_{query}"),
    ...
    //return _cache.GetOrAddCachedDataAsync($"wiz_time_{arg}",
    //    GetTimeDataFactory,
    //    arg,
    ...
    public string GetRandomImageUrl(ImageTag tag)
    {
        ...
        return $"https://wizbot-images.nyc3.digitaloceanspaces.com/{subpath}/"
