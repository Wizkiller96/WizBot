...
namespace WizBot.Modules
{
    public abstract class WizBotModule : ModuleBase
    {
        ...
        {
            var text = WizBot.ResponsesResourceManager.GetString(lowerModuleTypeName + "_" + key, _cultureInfo);
            ...
            if (string.IsNullOrWhiteSpace(text))
            {
                ...
                return WizBot.ResponsesResourceManager.GetString(lowerModuleTypeName + "_" + key, usCultureInfo) ?? $"Error: dkey {lowerModuleTypeName + "_" + key} found!";
            }
