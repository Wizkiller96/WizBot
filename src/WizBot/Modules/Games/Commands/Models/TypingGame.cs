...
namespace WizBot.Modules.Games.Models
{
    public class TypingGame
    {
        ...
        public string GetRandomSentence()
        {
            if (_games.TypingArticles.Any())
                return _games.TypingArticles[new WizBotRandom().Next(0, _games.TypingArticles.Count)].Text;
            else
                return $"No typing articles found. Use {WizBot.Prefix}typeadd command to add a new article for typing.";
