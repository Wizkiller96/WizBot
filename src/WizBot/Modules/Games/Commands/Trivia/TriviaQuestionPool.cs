...
namespace WizBot.Modules.Games.Trivia
{
    public class TriviaQuestionPool
    {
        ...
        private Random rng { get; } = new WizBotRandom();
        ...
        public TriviaQuestion GetRandomQuestion(HashSet<TriviaQuestion> exclude, bool isPokemon)
        {
            ...
            if (isPokemon)
            {
                ...
                return new TriviaQuestion("Who's That Pokémon?",
                    map[num].ToTitleCase(),
                    "Pokemon",
                    $@"http://wizbot-db.wizkiller96network.com/images/pokemon/shadows/{num}.png",
                    $@"http://wizbot-db.wizkiller96network.com/images/pokemon/real/{num}.png");
            }
