    ...
    public partial class Games
    {
        ...
        public class PlantPickCommands
        {
            ...
            public async Task Plant(IUserMessage imsg)
            {
                ...
                var msgToSend = $"Oh how Nice! **{imsg.Author.Username}** planted {(vowelFirst ? "an" : "a")} {Gambling.Gambling.CurrencyName}. Pick it using {WizBot.ModulePrefixes[typeof(Games).Name]}pick";
                if (file == null)
                {
