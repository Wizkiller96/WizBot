...
public class OfficialGpt3Session : IChatterBotSession
{
        ...
        IHttpClientFactory factory)
    {
        ...
        messages.Add(new GPTMessage(){Role = "user", Content = personality, Name = _wizbotUsername});
    }
    ...
    public async Task<string> Think(string input, string username)
    {
        ...
        try
        {
            ...
            messages.Add(new GPTMessage(){Role = "assistant", Content = message, Name = _wizbotUsername});
            return message;
        }
        catch
        {
