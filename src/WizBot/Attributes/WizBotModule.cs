...
namespace WizBot.Attributes
{
    ...
    sealed class WizBotModuleAttribute : ModuleAttribute
    {
        //modulename / prefix
        ...
        public WizBotModuleAttribute(string moduleName, string defaultPrefix) : base(GetModulePrefix(moduleName, defaultPrefix))
        {
            AppendSpace = false;
        }
