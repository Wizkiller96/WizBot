...
namespace WizBot.Migrations
{
    ...
    [Migration("20250118235223_fish-skill")]
    partial class fishskill
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WizBot.Db.Models.ExcludedItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("WizBot.Db.Models.AntiAltSetting", b =>
                {
                    b.HasOne("WizBot.Db.Models.GuildConfig", null)
                        ...
                        .HasForeignKey("WizBot.Db.Models.AntiAltSetting", "GuildConfigId")
            ...
            modelBuilder.Entity("WizBot.Db.Models.AntiRaidSetting", b =>
                {
                    b.HasOne("WizBot.Db.Models.GuildConfig", null)
                        ...
                        .HasForeignKey("WizBot.Db.Models.AntiRaidSetting", "GuildConfigId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("WizBot.Db.Models.AntiSpamSetting", b =>
                {
                    b.HasOne("WizBot.Db.Models.GuildConfig", null)
                        ...
                        .HasForeignKey("WizBot.Db.Models.AntiSpamSetting", "GuildConfigId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("WizBot.Db.Models.ExcludedItem", b =>
                {
                    b.HasOne("WizBot.Db.Models.XpSettings", "XpSettings")
            ...
            modelBuilder.Entity("WizBot.Db.Models.StreamRoleSettings", b =>
                {
                    b.HasOne("WizBot.Db.Models.GuildConfig", "GuildConfig")
                        .WithOne("StreamRole")
                        .HasForeignKey("WizBot.Db.Models.StreamRoleSettings", "GuildConfigId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("WizBot.Db.Models.XpSettings", b =>
                {
                    b.HasOne("WizBot.Db.Models.GuildConfig", "GuildConfig")
                        .WithOne("XpSettings")
                        .HasForeignKey("WizBot.Db.Models.XpSettings", "GuildConfigId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
