...
namespace WizBot.Db
{
    public static class GuildConfigExtensions
    {
        ...
        public static StreamRoleSettings GetStreamRoleSettings(this WizBotContext ctx, ulong guildId)
        {
        ...
        public static GuildConfig GuildConfigsForId(this WizBotContext ctx, ulong guildId, Func<DbSet<GuildConfig>, IQueryable<GuildConfig>> includes = null)
        {
            GuildConfig config;
        ...
        public static LogSetting LogSettingsFor(this WizBotContext ctx, ulong guildId)
        {
        ...
        public static GuildConfig GcWithPermissionsv2For(this WizBotContext ctx, ulong guildId)
        {
            var config = ctx
                .GuildConfigs
                .AsQueryable()
        ...
        public static XpSettings XpSettingsFor(this WizBotContext ctx, ulong guildId)
        {
