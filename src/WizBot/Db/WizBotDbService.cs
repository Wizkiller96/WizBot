...
public sealed class WizBotDbService : DbService 
{
    ...
    public WizBotDbService(IBotCredsProvider creds)
    {
    ...
    public override WizBotContext CreateRawDbContext(string dbType, string connString)
    {
        switch (dbType)
        {
            case "postgresql":
    ...
    public override WizBotContext GetDbContext()
