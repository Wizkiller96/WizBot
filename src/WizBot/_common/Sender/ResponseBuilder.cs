...
public sealed partial class ResponseBuilder
{
    ...
    private WizInteractionBase? inter;
    ...
    public ResponseBuilder Interaction(WizInteractionBase? interaction)
    {
        inter = interaction;
        return this;
    }
...
public sealed class SourcedPaginatedResponseBuilder<T> : PaginatedResponseBuilder
{
    ...
    public Func<int, Task<WizInteractionBase>>? InteractionFunc { get; private set; }
    ...
    public SourcedPaginatedResponseBuilder<T> Interaction(Func<int, Task<WizInteractionBase>> func)
    {
        InteractionFunc = func; //async (i) => await func(i);
        return this;
    }

    public SourcedPaginatedResponseBuilder<T> Interaction(WizInteractionBase inter)
    {
