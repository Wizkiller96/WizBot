...
public sealed partial class ResponseBuilder
{
    ...
    public ResponseBuilder Interaction(WizBotInteractionBase? interaction)
    {
        inter = interaction;
        return this;
    }
...
public sealed class SourcedPaginatedResponseBuilder<T> : PaginatedResponseBuilder
{
    ...
    public Func<int, Task<WizBotInteractionBase>>? InteractionFunc { get; private set; }
    ...
    public SourcedPaginatedResponseBuilder<T> Interaction(Func<int, Task<WizBotInteractionBase>> func)
    {
        InteractionFunc = func; //async (i) => await func(i);
        return this;
    }

    public SourcedPaginatedResponseBuilder<T> Interaction(WizBotInteractionBase inter)
    {
