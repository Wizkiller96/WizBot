    ...
    internal class OsuCommands : DiscordCommand
    {
        ...
        internal override void Init(CommandGroupBuilder cgb)
        {
            ...
            cgb.CreateCommand(Module.Prefix + "osu b")
                ...
                .Do(async e =>
                {
                    if (string.IsNullOrWhiteSpace(WizBot.Creds.OsuAPIKey))
                    {
                    ...
                    try
                    {
                        ...
                        var reqString = $"https://osu.ppy.sh/api/get_beatmaps?k={WizBot.Creds.OsuAPIKey}&{mapId}";
            ...
            cgb.CreateCommand(Module.Prefix + "osu top5")
                ...
                .Do(async e =>
                {
                    ...
                    try
                    {
                        ...
                        var reqString = $"https://osu.ppy.sh/api/get_user_best?k={WizBot.Creds.OsuAPIKey}&u={Uri.EscapeDataString(e.GetArg("usr"))}&type=string&limit=5&m={m}";
                        ...
                        {
                            var mapReqString = $"https://osu.ppy.sh/api/get_beatmaps?k={WizBot.Creds.OsuAPIKey}&b={item["beatmap_id"]}";
