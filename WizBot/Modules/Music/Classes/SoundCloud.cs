...
namespace WizBot.Modules.Music.Classes
{
    public class SoundCloud
    {
        ...
        public async Task<SoundCloudVideo> GetVideoAsync(string url)
        {
            ...
            var response = await SearchHelper.GetResponseStringAsync($"http://api.soundcloud.com/resolve?url={url}&client_id={WizBot.Creds.SoundCloudClientID}").ConfigureAwait(false);
