...
using WizBot.Modules.Utility.Commands;
using System;
using System.Linq;
...
namespace WizBot.Modules.Utility
{
    internal class UtilityModule : DiscordModule
    {
        ...
        public override string Prefix => WizBot.Config.CommandPrefixes.Utility;
        ...
        public override void Install(ModuleManager manager)
        {
            ...
            manager.CreateCommands("", cgb =>
            {
                ...
                cgb.CreateCommand(Prefix + "stats")
                    .Description($"Shows some basic stats for WizBot. | `{Prefix}stats`")
                    .Do(async e =>
                    {
                        await e.Channel.SendMessage(await WizStats.Instance.GetStats()).ConfigureAwait(false);
                    });

                cgb.CreateCommand(Prefix + "dysyd")
                    .Description($"Shows some basic stats for WizBot. | `{Prefix}dysyd`")
                    .Do(async e =>
                    {
