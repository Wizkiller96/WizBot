        ...
        public override void Install(ModuleManager manager)
        {
            manager.CreateCommands("", cgb =>
            {
                ...
                cgb.CreateCommand(Prefix + "heal")
                    .Description($"Heals someone. Revives those who fainted. Costs a {WizBot.Config.CurrencyName} | `{Prefix}heal @someone`")
                    .Parameter("target", ParameterType.Unparsed)
                    .Do(async e =>
                    {
                        var targetStr = e.GetArg("target")?.Trim();
                ...
                cgb.CreateCommand(Prefix + "settype")
                    .Description($"Set your poketype. Costs a {WizBot.Config.CurrencyName}. | `{Prefix}settype fire`")
