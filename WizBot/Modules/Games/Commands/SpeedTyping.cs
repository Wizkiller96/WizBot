...
namespace WizBot.Modules.Games.Commands
{
    ...
    public class TypingGame
    {
        ...
        private async void AnswerReceived(object sender, MessageEventArgs e)
        {
            try
            {
                if (e.Channel == null || e.Channel.Id != channel.Id || e.User.Id == WizBot.Client.CurrentUser.Id) return;
    ...
    internal class SpeedTyping : DiscordCommand
    {
        ...
        internal override void Init(CommandGroupBuilder cgb)
        {
            ...
            cgb.CreateCommand(Module.Prefix + "typeadd")
                ...
                .Do(async e =>
                {
                    if (!WizBot.IsOwner(e.User.Id) || string.IsNullOrWhiteSpace(e.GetArg("text"))) return;
