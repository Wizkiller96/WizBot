...
namespace WizBot.Classes.JSONModels
{
    ...
    public static class ConfigHandler
    {
        ...
        public static bool IsServerBlacklisted(ulong id) => WizBot.Config.ServerBlacklist.Contains(id);

        public static bool IsChannelBlacklisted(ulong id) => WizBot.Config.ChannelBlacklist.Contains(id);

        public static bool IsUserBlacklisted(ulong id) => WizBot.Config.UserBlacklist.Contains(id);
    }
