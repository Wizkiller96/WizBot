...
Version: `WizBot v0.9.5989.40535`
### Administration  
...
`.addcustomreaction`, `.acr`  |  Add a custom reaction. Guide here: <Coming Soon> **Owner Only!**   |  .acr "hello" I love saying hello to %user%
...
`.unotes`  | Gives a list of updates that have been done to WizBot.
...
`$$$`  |  Check how much WizFlowers a person has. (Defaults to yourself) | `$$$` or `$$$ @Someone`
...
`@BotName neko`  | Shows a random picture of a neko girl.  | %mention% neko
