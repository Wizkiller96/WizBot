...
namespace WizBot.Core.Services.Impl
{
    public class BotCredentials : IBotCredentials
    {
        ...
        public BotCredentials()
        {
            ...
            try
            {
                ...
                if (string.IsNullOrWhiteSpace(portStr))
                    ShardRunPort = new WizBotRandom().Next(5000, 6000);
                else
        ...
        private class CredentialsModel : IBotCredentials
        {
            ...
            ImmutableArray<ulong> IBotCredentials.AdminIds => throw new NotImplementedException();
